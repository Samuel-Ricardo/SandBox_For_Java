 ...
 */
public class TextFieldFormatterFX {
    ...
    public TextFieldFormatterFX() {
        mf = new MaskFormatter();
    }

    public void formatter(TextField textField, String Caracter, String mask) {
        try {
            mf.setMask(mask);
        ...
        mf.setValidCharacters(Caracter);
